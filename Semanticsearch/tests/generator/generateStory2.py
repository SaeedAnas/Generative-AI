...
# Generate story
story = intro
for _ in range(50000):  # Iterate to create a large story
...
with open(os.path.join(output_directory, "large_story2.txt"), "w", encoding="utf-8") as file:
    file.write(story[:5000000])  # Truncate to save the initial 5MB
